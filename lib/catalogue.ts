import type { Category, ConfigField, PriceTier, PriceTiers, Product } from "./types";
...
// ---- HS-code list pricing -------------------------------------------------
// Two preset tiers: Top 50 ($399) and Top 100 ($899). Beyond 100, contact us
// at $10 per additional contact.
const HS_LIST_TIERS: PriceTier[] = [
  { value: "50",  label: "Top 50",  priceCents: 39900 },
  { value: "100", label: "Top 100", priceCents: 89900 },
];

const HS_LIST_PRICING: PriceTiers = {
  field: "list_size",
  tiers: HS_LIST_TIERS,
};

function listSizeField(): ConfigField {
  return {
    name: "list_size",
    label: "List size",
    type: "select",
...
export const PRODUCTS: Product[] = [
  ...
  {
    sku: "CI-004",
    slug: "buyers-by-hs-code",
    title: "Buyers by HS Code",
    categorySlug: "company-supplier",
    shortDescription:
      "Ranked global buyers for a specific HS code, with trade values and contact details.",
    fullDescription:
      "A ranked list of active buyers worldwide for a specific HS code, built from customs and bill-of-lading data. Each entry includes the buyer's country, trade value, and shipment volumes, with contactable company profiles where available. Top 50 for $399, Top 100 for $899. Need more than 100? Contact us at $10 per additional contact.",
    includes: [
      "Buyers ranked by trade value",
      "Country and shipment volumes per buyer",
    ...
    isSubscription: false,
    isConfigurable: true,
    configFields: [f.hs(), listSizeField()],
    priceTiers: HS_LIST_PRICING,
    featured: true,
  },
  {
    sku: "CI-005",
    slug: "suppliers-by-hs-code",
    title: "Suppliers by HS Code",
    categorySlug: "company-supplier",
    shortDescription:
      "Ranked global suppliers for a specific HS code, with trade values and contact details.",
    fullDescription:
      "A ranked list of active suppliers and exporters worldwide for a specific HS code, built from customs and bill-of-lading data. Each entry includes the supplier's country, trade value, and shipment volumes, with contactable company profiles where available. Top 50 for $399, Top 100 for $899. Need more than 100? Contact us at $10 per additional contact.",
    includes: [
      "Suppliers ranked by trade value",
      "Country and shipment volumes per supplier",
      "Contactable company profiles where available",
      "Monthly volume, value and unit-price statistics",
      "Watermarked PDF, optional DOCX",
      "Standard delivery 72h, urgent 24h delivery available on request, contact us",
