...
| 1a | `docs/ponte-authority/PT-PRODUCT-2026-07-26-02-ENGLISH-FIRST-LANGUAGE-POLICY.md` | English-First Language and Localisation Policy | **Approved 26 July 2026.** Ponte is English-first with a single interface language. The `next-intl` and `[locale]` structure is legacy compatibility infrastructure, not future architecture. |
