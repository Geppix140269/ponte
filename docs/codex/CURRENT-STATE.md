...
| Listing exception console | Not started | `/admin/listings` still presents the pre-ADR-0013 queue | The statuses, flag columns, reasons, severities and indexes exist; the screen has not been rebuilt to lead with flagged, suspended and incomplete cases or to filter by flag reason and severity. |
