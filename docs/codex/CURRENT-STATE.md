...
2. Deploy and production-verify the Market Signals search and pagination delivered for LB-006, then classify the existing inventory (PL-017) and reconcile the new batch (PL-018), which are the parts of ADR-0011 that remain.
