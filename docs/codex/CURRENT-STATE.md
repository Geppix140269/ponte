...
| Contrast and colour remediation | Designed | Not started | ADR-0015 accepted 29 July 2026, with owner sign-off S-1 to S-5 the same day; Constitution v1.1. Governance records only. **No production token, stylesheet or component has changed.** Stage 0a is the PL-004 checker fix, Stage 0b the governance PR; both must merge before Stage 1 opens. Stage 1 covers structural tokens, the value-neutral alias conversion of four duplicated stylesheets, Bridge deck and passive pier contrast, the 11px mobile caption floor and the Bridge manifest decoupling as step 0. Stage 2 (the `--pf-interact-*` family) follows, journey by journey. LB-001 and LB-002 open with fixed closure criteria. OD-006, OD-007 and OD-008 decided. |
