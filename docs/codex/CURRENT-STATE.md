...
One reading inside the engine needs owner confirmation: whether a **broker's**
branch counts toward the price, where authority §4 and §7 point different ways
(**OD-012**). It is implemented as counting, named in one constant and pinned by
one test.
