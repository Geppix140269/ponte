        ...
        <div>
          ...
          <div className="mt-7 glass-tight p-7">
            ...
            <p className="mt-5 text-[12px] leading-relaxed text-gray-2">
              ...
              official sources. Where sources conflict, outliers are
              identified first and Monte Carlo models are used to calculate the
              most likely outcome. AI can make mistakes.
            </p>
          </div>
