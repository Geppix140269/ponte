...
import LegalOriginalNotice from "@/components/LegalOriginalNotice";
...
export function generateMetadata({
  ...
  return {
    title: "Terms",
    description:
      "Terms for the Ponte marketplace and for desk engagements. Ponte is operated by 1402 Celsius Ltd (Bulgaria).",
...
// The legal text itself stays in English on every locale. See LANGUAGES.md.
