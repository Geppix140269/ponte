...
--
-- Renamed from `20260728d_` to `20260728e_` on 29 July 2026 under the owner
-- decision on issue #97 (PL-004). It shared the identifier `20260728d` with
-- `20260728d_verification_level_canonical.sql`, which is already applied to
-- production and recorded in `public.schema_migrations` under that exact name
-- with its SHA-256. The applied file therefore keeps its identity, and this
-- unapplied one moves. Nothing inside this migration changed.
--
